    ...
    <div class="panel-body">
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="col-xs-12 col-md-4">
                    <div class="col-md-4 no-pad"> <!-- control buttons -->
                        ...
                        <button id="undo" class="btn btn-danger btn-block"><i class="fa fa-undo"></i>&nbsp;Undo</button>
                        
                        <button id="skip" class="btn btn-info btn-block" data-toggle="tooltip" rel='tooltip' data-placement="right" title="Skip this for manual editing."><i class="fa fa-check"></i>&nbsp;Skip</button>
                        <a class="btn btn-primary btn-block" href="<?php echo $this->createUrl('site/next') ;?>"><i class="fa fa-arrow-right"></i>&nbsp;Next</a>
                        <br>
                    </div>
                    ...
                    <div class="col-md-8"> <!-- thumbnail -->
                        ...
                        <div class="no-pad">
                            <div class="thumbnail">
                                <a href="<?php echo $image->getBackendAdLink($model->id); ?>">
        ...
        <div class="row">
            <div class="col-md-12">
               ...
               <div class="summernote" id="Ad_description" name="Ad[description]" ></div>
               ...
               <div class="detail-footer">
                   <button class="btn btn-primary btn-large"><i class="fa fa-arrow-right"></i>&nbsp;Next</button>
                   <button class="btn btn-default"><i class="fa fa-shopping-cart"></i>&nbsp; Save All</button>
                   <button class="btn btn-danger"><i class="fa fa-envelope-o"></i>&nbsp; Skip</button>
               </div>
           </div>
        </div>
    </div>
