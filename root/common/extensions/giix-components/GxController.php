...
abstract class GxController extends Controller {
    /**
     * The constants are used for image cropping in model AdImage and table image
     * The field name of model AdImage is cropped
     */
    /** @const The file is downloaded but not cropped yet  */
    const UNCROPPED = 1;
    /** @const This file has been cropped and ready for use  */
    const CROPPED = 2;
    /** @const The user is currently cropping this image  */
    const CROPPING = 3;
    /** @const The crop is undone because it was not correct & redoing needed */
    const CROPUNDONE = 4;
    /** @const The file does not exist on drive  */
    const CROPNOTEXIST = 5;
    /** @const This should be cropped manually   */
    const CROPSKIPPED = 6; 
    
    /**
     * The constants are used for editing details of AD in model AD and table ad
     * The field name is edited
     */
    /** @const The description of AD is not yet edited  */
    const UNEDITED = 1;
    /** @const The description of AD  is edited  */
    const EDITED = 2;
    /** @const The user is currently editing this AD  */
    const EDITING = 3;
    /** @const The user has skipped editing this AD  */
    const EDITSKIPPED = 4;
    /** @const The AD is autoedited  */
    const EDITEDAUTO= 5;
