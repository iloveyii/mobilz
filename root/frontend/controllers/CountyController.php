...
class CountyController extends BaseFrontendController
{
	/**
	...
	{
		$model=County::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param County $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='county-form')
		{
