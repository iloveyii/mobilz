            ...
            <div class="modal-body" style="padding: 20px 0 0;">
                ...
                <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <?php echo CHtml::link('Glömt Lösenord? ',array('site/forgotpassword'), array('class'=>'pull-right')); ?>
                            <br />
                        </div>
                        <?php echo CHtml::submitButton('Logga in', array('class'=>'btn btn-lg btn-success btn-block')); ?>
                    </fieldset>
                    
                    <hr/>
                    <a class="btn btn-lg btn-facebook btn-block" href="<?php echo Yii::app()->createAbsoluteUrl('site/login');?>?social=facebook" title="Login via facebook">Login via facebook</a>
